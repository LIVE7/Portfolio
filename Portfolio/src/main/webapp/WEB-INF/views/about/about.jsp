		...
		<div class="row">
			<div class="col-lg-8 mx-auto">
				...
				<p class="text-white-50">
					어렸을 때부터 컴퓨터 다루는 것을 좋아하였고<br>무언가를 만드는 것에 흥미를 느끼게 되면서&nbsp;<br>프로그래머라는
					꿈을 갖게 되었습니다.&nbsp;<br>대학을 다니며 프로그래밍에 대해 많은 것을 배우고<br>프로젝트를 통해 직접 개발도 해보았습니다.
					<br>졸업 이후에도 웹 개발자 양성과정을 수료하면서<br>자연스럽게 해당 분야에도
					흥미를 갖게 되었으며<br>지금도 개발자가 되기 위해 많은 노력을 하고 있습니다.<br> <br>
					<br> 제 목표는 <span class="text text-warning" style="font-weight: bold;">'잘하는 개발자'</span>입니다. <br> 주어진 업무에 최선을 다하며 IT기술의 변화에
