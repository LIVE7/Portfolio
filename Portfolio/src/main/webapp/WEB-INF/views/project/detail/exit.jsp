	...
	<div class="container">
		<div class="row bg-light">
			...
			<div class="col-md-12 text-center mt-3">
				<h2 style="font-weight: bold;">EXIT</h2>
			</div>
			<div class="col-md-12 text-center mt-3">
				<h2 style="font-weight: bold;">3인칭 액션 게임</h2>
			</div>
			<div class="col-md-12">
				<hr color="blue">
			</div>
			<div class="col-md-6">
				<img class="img-fluid d-block" src="./img/projects/exit.png">
			</div>
			<div class="col-md-6">
				<br>
				<li><span>팀 프로젝트</span></li> <br>
				<li><span>역할: 기획, 프로그래밍, 사운드</span></li> <br>
				<li><span>Completed</span>: 2018</li> <br>
				<li><span>Github</span>: <a
					href="https://bitbucket.org/LIVE7/exit/src/master/" target="_blank">https://bitbucket.org/LIVE7/exit/src/master/</a></li>
			</div>
			<div class="col-md-12 bg-light">
				<hr color="blue">
			</div>
			<div class="col-md-12">폐쇄된 병원에 원인을 모른 채 끌려온 주인공이 3층부터 각 층을 탈출하며
				최종적으로 폐쇄된 병원을 탈출하는 내용의 게임입니다.</div>
			<div class="col-md-12 bg-light">
				<hr color="blue">
			</div>
			...
			<div class="col-md-12">
				<div class="text-center video-container">
					<iframe width="720" height="480"
						src="https://www.youtube.com/embed/Ri8Mna4MTyo?start=134"
						frameborder="0"
...
<script>
	...
	typewriter.typeString('EXIT').pauseFor(20000).start();
</script>
